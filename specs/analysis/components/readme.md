...
<!-- TODO: - **design-tokens.md** - Colors, spacing, typography, module-based theming -->
<!-- TODO: - **state-colors.md** - Appointment state color palette with hex values -->
...
See [state-colors.md](./state-colors.md) for appointment state color palette. -->

...
|------|-----------|--------|-----------------|---------------------|
| include | **Included by** | `{{> sendMessage}}` | [Calendar View](01-dashboard/calendar-view.md) | BIRTHDAY event click opens send-message dialog |
| include | **Included by** | `{{> sendMessage}}` | [Month View](01-dashboard/month-view.md) | Birthday flow send message |
| include | **Included by** | `{{> sendMessage}}` | [Week View](01-dashboard/week-view.md) | Birthday flow send message |

### Event Flows

| Type | Direction | Event | Linked Document | Condition |
|------|-----------|-------|-----------------|----------|
| event | **Outgoing** | `sendUserMessage({ to, subject, message })` | [Calendar View](01-dashboard/calendar-view.md) | BIRTHDAY calendar event click |
...
> **Include context:** `sendMessage.mustache` is a shared partial embedded in [Calendar View](01-dashboard/calendar-view.md), [Month View](01-dashboard/month-view.md), and [Week View](01-dashboard/week-view.md) for sending birthday and other notifications.
>
> **Event chain:** [Calendar View](01-dashboard/calendar-view.md) -> BIRTHDAY click -> `sendUserMessage()` -> **this file** (sendMessage partial)

...
describe('account router', () => {
  describe('submitOnboarding', () => {
    ...
    it('should succeed for an authenticated user', async () => {
      await expect(call(accountRouter.submitOnboarding, onboardingInput)).resolves.toBeUndefined();
    });
    ...
    it('should throw UNAUTHORIZED when user is not authenticated', async () => {
      ...
      await expect(call(accountRouter.submitOnboarding, onboardingInput)).rejects.toMatchObject({
        code: 'UNAUTHORIZED',
      });
    });
  });
  ...
  describe('updateInfo', () => {
    ...
    it('should succeed for an authenticated user', async () => {
      await expect(call(accountRouter.updateInfo, updateInput)).resolves.toBeUndefined();
    });
    ...
    it('should throw UNAUTHORIZED when user is not authenticated', async () => {
      ...
      await expect(call(accountRouter.updateInfo, updateInput)).rejects.toMatchObject({
        code: 'UNAUTHORIZED',
      });
    });
  });

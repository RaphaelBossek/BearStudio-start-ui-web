...
|------|---------------------|
| [totp-onboarding.md](../analysis/user-management/admin/totp-onboarding.md) | [includes-customization.md](../analysis/system/includes/includes-customization.md) (TOTP onboarding flow in login: `require.token`/`missing.token` handling, QR code display, `#totpTokenSecret`, TOTP input widget, migration note for shadcn `InputOTP`), [data-dictionary-user-management.md](../analysis/user-management/data-dictionary-user-management.md) (§13: TOTP Onboarding fields, `UserService.checkTotp`, `UserService.resetTotp`), [user-management.md](../analysis/user-management/admin/user-management.md) (`user.requireTotp` switch, `UserService.clearTotp(id)` action, `twoFactorReset` button), [includes-shared-components.md](../analysis/system/includes/includes-shared-components.md) (`userSecurity.html` link in desktop/mobile nav dropdown), [profile-form.md](../analysis/user-management/profile/profile-form.md) (`data.requireTotp` checkbox, ADMIN only), [profile-staff.md](../analysis/user-management/profile/profile-staff.md) (`requireTotp` grid column with lock icon) |
...
| [profile-staff.md](../analysis/user-management/profile/profile-staff.md) | [onboarding-flow.md](../analysis/user-management/admin/onboarding-flow.md) (include: `{{> onboardingDlg}}`; event: `openOnboarding(id, "EMPLOYEE")`), [profile-dialogs.md](../analysis/user-management/profile/profile-dialogs.md) (include: `{{> passwordDlg}}`, `{{> signaturePad}}`), [appointment-assign-user.md](../analysis/planning/appointment/appointment-assign-user.md) (include: `{{> assignUserDlg}}`) |

...
|------|-----------|-------|-----------------|----------|
| event | **Incoming** | `loadBasisweb` | [Consultation Wizard](01-dashboard/consultation-wizard.md#2-dialog-navigation-diagram) | `location.patientDataType == "EXTERNAL_BASISWEB"` && `appointment.state != "LOCKEDIN"` |
| event | **Outgoing** | `ConsultationDetails.open()` | [Consultation Details JS](_shared-components/consultation-details-js.md#2-dialog-lifecycle) | After BasisWeb decryption succeeds (step 6 bww-success) |

> **Event chain:** [Dashboard Main](01-dashboard/dashboard-main.md) -> `loadConsultation` -> [Consultation Wizard](01-dashboard/consultation-wizard.md) -> `loadBasisweb` -> **this file** -> `ConsultationDetails.open()` -> [Consultation Details JS](_shared-components/consultation-details-js.md)

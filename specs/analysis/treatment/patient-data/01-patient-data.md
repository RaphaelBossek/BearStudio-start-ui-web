> **Split from**: `entity-cruds/01-room-equipment-contact-medication-patientdata.md`
> **Sections extracted here**: Common CRUD Pattern, 5. PatientData, Cross-Module Summary
> **Other domains received**: `customer/room/01-room.md` (Common CRUD Pattern, 1. Room, Cross-Module Summary), `customer/equipment/01-equipment.md` (Common CRUD Pattern, 2. Equipment, Cross-Module Summary), `customer/contact/01-contact.md` (Common CRUD Pattern, 3. Contact, Cross-Module Summary), `treatment/medication/01-medication.md` (Common CRUD Pattern, 4. Medication, Cross-Module Summary)

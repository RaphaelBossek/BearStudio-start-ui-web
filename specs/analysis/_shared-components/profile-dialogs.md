...
| include | **Included by** | `{{> searchEmployee}}` | [Shared Components](_shared-components/includes-shared-components.md#cross-references) | Global employee search dialog included across modules |

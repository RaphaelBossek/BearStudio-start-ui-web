...
> **Other domains received**: `treatment/appointment-patient/02-appointment-details-patient.md` got patient data CRUD (add/edit/remove patient), patient file uploads/downloads, patient data attachments

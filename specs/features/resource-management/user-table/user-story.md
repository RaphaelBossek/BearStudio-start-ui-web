...
### UI/UX Requirements
1. **Shadcn Table**: Use `@tanstack/react-table` with shadcn/ui components.
2. **Column Visibility Toggle**: A dropdown menu to select active columns.
3. **Responsive Design**: Ensure the table is scrollable and readable on desktop/tablets.

...
|------|-----------|--------|-----------------|---------------------|
| include | **Included by** | `{{> patientData}}` | [Appointment Details Patient](_shared-components/appointment-details-scheduling.md) | Patient data tab in appointment details |
| split | **Sibling** | Same source: `room-equipment-contact-medication-patientdata.md` | [Room Entity CRUD](09-customers/rooms.md) | Room module extracted to sibling |
| split | **Sibling** | Same source: `room-equipment-contact-medication-patientdata.md` | [Equipment Entity CRUD](11-administration/equipment.md) | Equipment module extracted to sibling |
| split | **Sibling** | Same source: `room-equipment-contact-medication-patientdata.md` | [Contact Entity CRUD](_shared-components/contact.md) | Contact module extracted to sibling |

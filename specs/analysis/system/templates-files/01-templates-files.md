...
> **Other domains received**: `accounting/worklog/01-worklog.md` got section 1 (Worklog); `accounting/invoice-receiver/01-invoice-receiver.md` got section 6 (Invoice Receiver); `academy/video-history/01-user-video-history.md` got section 5 (User Video History)

...
markdown_content = """# Data Dictionary — System (Tier 3)
...
| Receiver | Empfanger | `data.calledNumber` | `cDRCall.calledNumber` (inferred) | [external-data.md#entity-anrufliste-cdr-calls](../mongodb-mapping/external-data.md#entity-anrufliste-cdr-calls) | `string` | `text` | — | No | Yes | Grid |
...
| UI Field Label (EN) | UI Field Label (DE) | Data Path (`data.*`) | MongoDB Path (`collection.field`) | DB Mapping Reference | Abstract Type | UI Element | Options/Enum | Required | Read-only | Notes |
|:---|:---|:---|:---|:---|:---|:---|:---|:---|:---|:---|
| ID | ID | `data.id` | `loginNotification._id` | [news.md#er-diagram](../mongodb-mapping/news.md#er-diagram) | `number` | `text` | — | No | Yes | Grid + Detail |
| Content | Name | `data.content` | `loginNotification.content` (inferred) | [news.md#er-diagram](../mongodb-mapping/news.md#er-diagram) | `bigstring` | `textarea` | — | No | No | Grid + Detail |
| From Date | `dateFilter.fromDate` | `data.dateFrom` | `loginNotification.dateFrom` | [news.md#er-diagram](../mongodb-mapping/news.md#er-diagram) | `datetime` | `date input` | — | No | No | Grid + Detail |
| To Date | `dateFilter.toDate` | `data.dateTo` | `loginNotification.dateTo` | [news.md#er-diagram](../mongodb-mapping/news.md#er-diagram) | `datetime` | `date input` | — | No | No | Grid + Detail |
| Active | Aktiv | `data.active` | `loginNotification.active` | [news.md#er-diagram](../mongodb-mapping/news.md#er-diagram) | `boolean` | `checkbox` | — | No | No | Grid + Detail |

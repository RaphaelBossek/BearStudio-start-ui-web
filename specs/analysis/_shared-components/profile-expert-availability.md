...
|------|-----------|--------|-----------------|---------------------|
| include | **Included by** | `<script src="/profile/expertDays.js">` | [Month View](01-dashboard/month-view.md) | Month availability grid logic for `#expertdaysMonthTable` |
| include | **Included by** | `<script src="/profile/expertWeek.js">` | [Week View](01-dashboard/week-view.md) | Week availability grid logic for `#expertWeekTable` |
| include | **Included by** | `<script src="/profile/expertWeek.js">` | [Treatment Plan](04-treatments/treatment-plan.md) | Week grid embedded in treatment plan create dialog |
...
> **Include context:** `expertDays.js` is loaded by [Month View](01-dashboard/month-view.md) and [Profile Form](../profile/profile-form.md); `expertWeek.js` is loaded by [Week View](01-dashboard/week-view.md), [Treatment Plan](04-treatments/treatment-plan.md), and [Profile Form](../profile/profile-form.md). Both scripts operate on table elements defined in the host page's HTML.

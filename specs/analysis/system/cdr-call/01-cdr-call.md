> **Split from**: `appointment-support/01-plan-cdr.md`
...
> **Other domains received**: `planning/appointment-support/01-appointment-plan.md` got AppointmentPlan + Close Month Dialog sections

...
1. All analysis documents in `specs/analysis/accounting/` are complete and reviewed:
   - `specs/analysis/accounting/invoice/` — Invoice List + Invoice Details analysis
   - `specs/analysis/accounting/worklog/` — Worklog list + weekly assignments matrix analysis
   - `specs/analysis/accounting/invoice-receiver/` — Invoice Receiver CRUD analysis
   - `specs/analysis/accounting/admin-job/` — Job Configuration analysis
   - `specs/analysis/accounting/config/` — Accounting Config modules analysis (storno groups, price lists, products, closed months, expert work monthly)
   - `specs/analysis/accounting/admin-workhour/` — Admin work hour analysis

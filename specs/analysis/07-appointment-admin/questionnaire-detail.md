...
| include | **Included by** | `{{> detailQuestionaire}}` | [Appointment Admin](07-appointment-admin/appointment-admin.md) | QM questionnaire view in admin panel |
...
> **Include context:** This file's source `detailQM.html` is embedded as `{{> detailQuestionaire}}` partial in [Dialogs Treatment](../dashboard/dialogs-treatment.md), [Consultation Details Header](../consultation/consultation-details-header.md), and [Appointment Admin](07-appointment-admin/appointment-admin.md). The `filterQm()` function defined here is called from [Consultation Details JS](../consultation/consultation-details-js.md) and [Dialogs Treatment](../dashboard/dialogs-treatment.md).

...
|------|-----------|-------|-----------------|-----------|
| event | **Outgoing** | `InvoiceDetails.open(id, "view")` | [Invoice Details](09-customers/invoice-details.md) | Show Invoice row action |
| event | **Outgoing** | `InvoiceDetails.open(id, "change")` | [Invoice Details](09-customers/invoice-details.md) | Edit Invoice row action |

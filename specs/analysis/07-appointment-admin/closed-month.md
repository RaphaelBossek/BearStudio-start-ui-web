...
|------|-----------|--------|-----------------|---------------------|
| include | **Included by** | `{{> closeMonth}}` | [Appointment Admin](07-appointment-admin/appointment-admin.md) | Toolbar close month button in navbar |
| include | **Included by** | `{{> closeMonth}}` | [Appointment Plan](02-appointments/appointment-plan.md) | Toolbar close month button in plan view |

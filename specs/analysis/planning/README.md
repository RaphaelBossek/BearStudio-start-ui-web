...
| File | Origin | Content |
|:---|:---|:---|
| `01-shift-and-plan.md` | `shift/` (whole) | Shift plan management |

### council/
| File | Origin | Content |
|:---|:---|:---|
| `01-council-and-plan.md` | `council/` (whole) | Council plan management |
...
| File | Origin | Content |
|:---|:---|:---|
| `01-appointment-admin.md` | `appointment-admin/` (whole) | Appointment administration views |

### dashboard/
| File | Origin | Content |
|:---|:---|:---|
| `02-dashboard-selfservice.md` | `dash/` (whole) | Self-service scheduling actions |
| `08-shift-dialog.md` | `dash/` (whole) | Shift scheduling dialog |

...
|------|-----------|--------|-----------------|---------------------|
| split | **Sibling** | Same source: `dash/index.htmlm` (lines 624-896) | [Dialogs Planning](01-dashboard/dialogs-planning.md) | Planning dialogs extracted from shared source |
| split | **Sibling** | Same source: `dash/index.htmlm` (lines 624-896) | [Dialogs Treatment](_shared-components/dialogs-treatment.md) | Treatment dialogs extracted from shared source |
| split | **Sibling** | Same source: `dash/index.htmlm` (lines 624-896) | [Dialogs User Management](_shared-components/dialogs-user-management.md) | User management dialogs extracted from shared source |
...
> **Include context:** This file's source `dash/index.htmlm` (lines 624-896) is shared with [Dialogs Planning](01-dashboard/dialogs-planning.md), [Dialogs Treatment](_shared-components/dialogs-treatment.md), and [Dialogs User Management](_shared-components/dialogs-user-management.md). Each file documents different dialog sections extracted from the same source.

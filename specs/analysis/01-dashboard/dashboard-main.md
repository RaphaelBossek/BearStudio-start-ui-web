...
|------|-----------|-------|-----------------|----------|
| event | **Outgoing** | `loadConsultation` | [Consultation Wizard](01-dashboard/consultation-wizard.md#2-dialog-navigation-diagram) | `newPatient` / `startBasisWeb` click on active appointment |
| event | **Outgoing** | `ConsultationDetails.open()` | [Consultation Details JS](_shared-components/consultation-details-js.md#2-dialog-lifecycle) | Consultation row click (editable) or treatment task edit |
| event | **Outgoing** | `consultationWithTemplateBtn` click | [Consultation Template](01-dashboard/consultation-template.md#click-actions) | NavBar "Consultation template" button (always visible) |
...
> **Downstream chains:**
> - `loadConsultation` → [Consultation Wizard](01-dashboard/consultation-wizard.md) → (conditionally) `loadBasisweb` → [BasisWeb Wizard](_interfaces/basisweb-wizard.md)
> - `ConsultationDetails.open()` → [Consultation Details JS](_shared-components/consultation-details-js.md)
> - `consultationWithTemplateBtn` → [Consultation Template](01-dashboard/consultation-template.md) → `ConsultationDetails.open()` → [Consultation Details JS](_shared-components/consultation-details-js.md)

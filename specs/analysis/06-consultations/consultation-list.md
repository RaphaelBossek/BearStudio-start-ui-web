...
| File | Purpose |
|------|---------|
| `web/src/main/webapp/consultation/index.htmlm` | Page template with table structure, CRUD config, and filter panel |
| `web/src/main/webapp/consultation/index.js` | Page behavior: grid loading, toolbar handlers, dialog interactions |

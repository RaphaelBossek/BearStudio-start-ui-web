...
- **Rights**: None
- **URL**: `/dash.html`
- **Analysis Doc**: `specs/analysis/system/dashboard/01-dashboard-main.md`
- **Submenu**:
  1. **Calendar**
     - English: Calendar
     - German: Kalender
  ...
  3. **Worklog**
     ...
     - Analysis Doc: `specs/analysis/accounting/worklog/01-worklog.md`
  4. **Video Library**
     ...
     - Analysis Doc: `specs/analysis/academy/support-video/01-support-and-video.md`
...
- **Analysis Doc**: `specs/analysis/planning/appointment/01-appointment-list.md`
- **Submenu**:
  1. **Appointment Plan**
     ...
     - Analysis Doc: `specs/analysis/planning/appointment-support/01-appointment-plan.md`
  2. **Patient Data**
     ...
     - Analysis Doc: `specs/analysis/treatment/patient-data/01-patient-data.md`
...
- **Rights**: None
- **URL**: `/shift.html`
- **Analysis Doc**: `specs/analysis/planning/shift/01-shift-and-plan.md`
- **Submenu**:
  1. **Shift Plan**
     - English: Shift Plan
     - German: Dienstplan
...
- **Rights**: None
- **URL**: `/treatment.html`
- **Analysis Doc**: `specs/analysis/treatment/treatment-core/01-treatment-and-category.md`
- **Submenu**:
  1. **Treatment Plan**
     ...
     - Analysis Doc: `specs/analysis/treatment/treatment-core/02-treatment-plan.md`
...
- **Analysis Doc**: `specs/analysis/treatment/consultation/01-consultation-list.md`
- **Submenu**: None (single-page module)
...
- **Analysis Doc**: `specs/analysis/planning/appointment-admin/01-appointment-admin.md`
- **Submenu**:
  1. **Closed Month**
     ...
     - Analysis Doc: `specs/analysis/accounting/config/01-accounting-config.md`
  2. **Questionnaire**
     ...
     - Analysis Doc: `specs/analysis/treatment/questionnaire/01-questionnaire-list.md`
...
- **Analysis Doc**: `specs/analysis/system/notification/01-notification.md`
- **Submenu**:
  1. **Trash**
     - English: Trash
     - German: Papierkorb
...
- **Rights**: None
- **URL**: `/customer.html`
- **Analysis Doc**: `specs/analysis/customer/customer-core/01-customer-list-detail.md`
- **Submenu**:
  1. **Onboarding Customer**
     ...
     - Analysis Doc: `specs/analysis/user-management/onboarding/01-onboarding-flow.md`
  2. **Invoices**
     - English: Invoices
     - German: Rechnungen
     ...
     - URL: `/invoice.html`
     - Analysis Doc: `specs/analysis/accounting/invoice/01-invoice-list.md`
  3. **Invoice Receivers**
     ...
     - Analysis Doc: `specs/analysis/accounting/invoice-receiver/01-invoice-receiver.md`
  4. **Customer Users**
     - English: Users
     - German: Benutzer
     ...
     - Analysis Doc: `specs/analysis/customer/customer-core/02-location-and-users.md`
  5. **Locations**
     - English: Locations
     - German: Standorte
  ...
  6. **Rooms**
     ...
     - Icon: `fa-building`
     - URL: `/room.html`
     - Analysis Doc: `specs/analysis/customer/room/01-room.md`
...
- **Rights**: None
- **URL**: `/staff.html`
- **Analysis Doc**: `specs/analysis/user-management/profile/01-profile-form.md`
- **Submenu**:
  1. **Onboarding**
     - English: Onboarding
     - German: Onboarding
  ...
  2. **User Management**
     ...
     - Icon: `fa-users`
     - URL: `/adminUser.html`
     - Analysis Doc: `specs/analysis/user-management/admin-user/02-user-management.md`
...
- **Submenu**:
  1. **Job IDs**
     ...
     - URL: `/job.html`
     - Analysis Doc: `specs/analysis/accounting/admin-job/03-job-configuration.md`
  2. **Async Job Queue**
  ...
  5. **Skills**
     ...
     - URL: `/skill.html`
     - Analysis Doc: `specs/analysis/user-management/admin-skill/04-skill.md`
  ...
  8. **Warnings**
     ...
     - URL: `/warning.html`
     - Analysis Doc: `specs/analysis/treatment/warning/01-warning-management.md`
  ...
  10. **Equipment**
      ...
      - Icon: `fa-tablet-alt`
      - URL: `/equipment.html`
      - Analysis Doc: `specs/analysis/customer/equipment/01-equipment.md`
  11. **Onboarding Steps**
...
- **Rights**: None
- **URL**: `/sysadmin.html`
- **Analysis Doc**: `specs/analysis/system/admin-system/01-admin-landing.md`
- **Submenu**:
  1. **MOTD**
     ...
     - Icon: `fa-newspaper`
     - URL: `/motd.html`
     - Analysis Doc: `specs/analysis/system/admin-cruds/04-motd-template.md`
  ...
  6. **Work Hours**
     ...
     - Icon: `fa-user-clock`
     - URL: `/workHour.html`
     - Analysis Doc: `specs/analysis/accounting/admin-workhour/04-workhour.md`
  7. **CDR**
     ...
     - Icon: `fa-boxes`
     - URL: `/CdrCall.html`
     - Analysis Doc: `specs/analysis/system/cdr-call/01-cdr-call.md`
  8. **CDR Assignment**
...
| **Settings** | Settings | Einstellungen | `administration.settings` → `administration.settings` | `fa-cog` | Always visible | `/profile.html` | `specs/analysis/user-management/profile/01-profile-form.md` |
| **Security** | Security | Sicherheit | `administration.security` → `administration.security` | `fa-id-card` | Always visible | `/userSecurity.html` | `specs/analysis/user-management/profile/03-profile-dialogs.md` |
| **Role Switch** | (Dynamic role label) | (Dynamische Rollenbezeichnung) | `role.{ROLE}` (hardcoded) | `fa-user-tag` | `roleSwitch=true` (authority: `USERS_CREATE`) | Opens `#roleSwitchDlg` | `specs/analysis/system/includes/01-includes-shared-components.md` |
| **Bug Report** | Bug Report | Fehlerbericht | — | (from include) | Always visible | Opens bug report dialog | `specs/analysis/system/includes/01-includes-shared-components.md` |
...
|----------|-------------|
| `specs/analysis/system/includes/01-includes-shared-components.md` | Shared components (navbar, siteloader, quick filter, job status) |
| `specs/analysis/system/includes/02-includes-customization.md` | Customization scripts and i18n overrides |
| `specs/analysis/system/notification/01-notification.md` | Notification system (messaging, folders, polling) |
| `specs/analysis/system/dashboard/dashboard-standard.md` | Dashboard main view (MOTD, stats, scheduling) |

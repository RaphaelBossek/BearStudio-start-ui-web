...
|------|-----------|-------|-----------------|----------|
| event | **Incoming** | `consultationWithTemplateBtn` click | [Dashboard Main](../../system/dashboard/dashboard-main.md#navbar-action-buttons) | NavBar "Consultation template" button (always visible) |

...
|------|-----------|-------|-----------------|----------|
| event | **Incoming** | `consultationWithTemplateBtn` click | [Dashboard Main](01-dashboard/dashboard-main.md#navbar-action-buttons) | NavBar "Consultation template" button (always visible) |
| event | **Outgoing** | `ConsultationDetails.open()` | [Consultation Details JS](../consultation/consultation-details-js.md#2-dialog-lifecycle) | After edit or create template, with `consultationTemplate=true` |

> **Event chain:** [Dashboard Main](01-dashboard/dashboard-main.md) -> `consultationWithTemplateBtn` click -> **this file** -> `ConsultationDetails.open()` -> [Consultation Details JS](../consultation/consultation-details-js.md)

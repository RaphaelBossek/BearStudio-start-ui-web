...
|------|-----------|--------|-----------------|---------------------|
| split | **Sibling** | Same source: `appointment/details.html` + `details.js` | [Appointment Details Scheduling](_shared-components/appointment-details-scheduling.md) | Tabs 1/2/4/5 (Scheduling, state, assignments) extracted to sibling |

...
|------|-----------|--------|-----------------|---------------------|
| include | **Includes** | `{{> appointmentDetails}}` | [Appointment Details Scheduling](_shared-components/appointment-details-scheduling.md) | Appointment detail view in month dashboard |
| include | **Includes** | `{{> shiftDlg}}` | [Shift Dialog](shift-dialog.md) | Shift detail dialog in month dashboard |
| script | **Loads** | `/profile/expertDays.js` | [Profile Expert Availability](_shared-components/profile-expert-availability.md) | Month-level expert availability grid logic for `#expertdaysMonthTable` |

...
|------|-----------|-------|-----------------|----------|
| event | **Incoming** | `ConsultationDetails.open()` | [Dashboard Main](01-dashboard/dashboard-main.md#block-consultations-table) | Consultation row click (editable) or treatment task edit |
...
| event | **Incoming** | `ConsultationDetails.open()` | [BasisWeb Wizard](_interfaces/basisweb-wizard.md#step-6-bww-success--summary) | After BasisWeb decryption succeeds |
...
> **Incoming chain:** [Dashboard Main](01-dashboard/dashboard-main.md) / [Consultation Wizard](../dashboard/consultation-wizard.md) / [BasisWeb Wizard](_interfaces/basisweb-wizard.md) / [Consultation Template](../dashboard/consultation-template.md) all call `ConsultationDetails.open()` -> **this file**
>

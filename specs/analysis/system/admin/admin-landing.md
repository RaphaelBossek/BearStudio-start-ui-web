...
| File | Purpose |
|------|---------|
| `web/src/main/webapp/admin/index.htmlm` | Regular admin landing page |
| `web/src/main/webapp/admin/sysadmin.htmlm` | Sysadmin landing page |
| `web/src/main/webapp/admin/nav.js` | Navigation configuration |
| `web/src/main/webapp/admin/changelog.htmlm` | Changelog page |
| `web/src/main/webapp/admin/group.htmlm` | Group management page |
| `web/src/main/webapp/admin/sysconfig.htmlm` | System configuration page |
| `web/src/main/webapp/admin/import.htmlm` | CSV import page |
